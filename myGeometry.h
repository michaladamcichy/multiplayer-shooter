...
double perpendicularDistance(vec2 pos, vec2 dir, vec2 point) {
    AlternativeLine line;
    line.define({pos.x, pos.y}, {pos.x + dir.x, pos.y + dir.y});
    return perpendicularDistance(line, {point.x, point.y});
}
